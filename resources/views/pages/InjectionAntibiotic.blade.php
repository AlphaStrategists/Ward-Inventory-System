...
<head>
    ...
    <title>Ward Inventory - Oral Antibiotic</title>
...
.sidebar__search button {
    ...
    align-items: center;
        ...
        /* stock-level colors for the qty badge */
...
<div class="sidebar__brand">
        ...
        <div class="navbar__titles">
            <span class="navbar__title">Injection Antibiotic</span>
    ...
    <!-- your existing drug-item rows stay exactly as they are -->
    <div class="drug-item drug-item--active">
        <span class="drug-item__name">Amoxicillin Cap</span>
        <span class="drug-item__qty qty--warning">18 amps</span>
            ...
            <div class="drug-item">
                <span class="drug-item__name">Ciprofloxacin Tab</span>
                <span class="drug-item__qty qty--good">12 amps</span>
            </div>
            <div class="drug-item">
                <span class="drug-item__name">Clarithromycin Tab</span>
                <span class="drug-item__qty qty--warning">8 vials</span>
            </div>
            <div class="drug-item">
                <span class="drug-item__name">Doxycycline Cap</span>
                <span class="drug-item__qty qty--neutral">24 amps</span>
            </div>
            <div class="drug-item">
                <span class="drug-item__name">Levofloxacin Tab</span>
                <span class="drug-item__qty qty--good">85 tabs</span>
            </div>
            <div class="drug-item">
            ...
            <div class="drug-item">
                ...
                <span class="drug-item__qty qty--good">150 ml</span>
            </div>
            <div class="drug-item">
                <span class="drug-item__name">Cefixime Tab</span>
                <span class="drug-item__qty qty--good">42 tabs</span>
            </div>
            <div class="drug-item">
                <span class="drug-item__name">Metronidazole Tab</span>
        ...
        <div class="content">
            ...
            <!-- Sub tabs -->
            <div class="sub-tabs">
                <button class="pill pill--active">Pharmacy Orders (2)</button>
               <!-- <button class="pill">Patient Administrations (4)</button>-->
            </div>
            ...
            <div class="log-card">
                ...
                <table class="log-table">
                    ...
                    <tbody>
                        <tr>
                            <td>08 Jul 2026</td>
                            <td class="req-no">REQ-2026-042</td>
                            <td>Amoxicilin Cap</td>
                            <td>10 amps</td>
                             <td>40 amps</td>
                            <td>Nurse Priya S.</td>
                            <td>20 amps</td>
