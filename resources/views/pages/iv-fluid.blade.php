...
<head>
    ...
    <title>Ward Inventory - IV Fluid Inventory Log</title>
    ...
    <style>
        ...
        *, *::before, *::after {
        ...
        .clear-btn {
            padding: 0.4375rem 0.875rem; background-color: #f1f5f9;
            border: 1px solid var(--border-color); border-radius: 8px;
        ...
        <aside class="sidebar">
            <div class="sidebar-header">
                ...
                <div style="display: flex; flex-direction: column;">
                    ...
                    <span style="font-size: 0.75rem; color: var(--text-secondary); font-weight: 600; letter-spacing: 0.05em; text-transform: uppercase;">IV-Fluid</span>
                </div>
            </div>
