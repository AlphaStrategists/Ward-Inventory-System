...
<head>
    ...
    <title>{{ config('app.name', 'Inventory_MGT_Ward(47 & 48)') }} — Create Account</title>
    ...
    <main class="relative flex min-h-[calc(100vh-73px)] items-center justify-center overflow-hidden px-8 py-16">
        ...
        <div class="relative z-10 grid w-full max-w-5xl grid-cols-2 overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-xl">
            ...
            <div
                ...
                <div>
                    ...
                    <h2 class="text-2xl font-bold leading-snug">
                        Join the Hospital Inventory Management System
                    </h2>

                    <p class="mt-4 text-sm leading-6 text-blue-50">
                        Create your staff account to start managing
                        medicines, surgical items, general inventory,
                        suppliers and stock.
                    </p>
                </div>
            ...
            <div class="flex flex-col justify-center p-10">
                ...
                <form method="POST" action="{{ route('storeUser') }}" class="space-y-5">
                    @csrf
                    ...
                    <!-- Role / Position -->
                    <div>
                        <label for="role" class="mb-1.5 block text-sm font-medium text-slate-700">
                            Role
                        </label>
                        <div class="relative">
                            <span class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3 text-slate-400">
                            ...
                            <select
                                ...
                                name="role"
                                required
                                class="w-full appearance-none rounded-xl border border-slate-200 bg-white py-2.5 pl-10 pr-10 text-sm text-slate-800 outline-none transition focus:border-transparent focus:ring-2"
                                style="--tw-ring-color: var(--color-primary);">
                    ...
                    <button
                        type="submit"
                        class="flex w-full items-center justify-center gap-2 rounded-xl px-4 py-3 text-sm font-semibold text-white shadow-md transition hover:-translate-y-0.5 cursor-pointer"
