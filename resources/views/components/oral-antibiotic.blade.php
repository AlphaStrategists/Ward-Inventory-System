...
<head>
    ...
    <title>Ward Inventory - Oral Antibiotic Inventory Log</title>
        ...
        <aside class="sidebar">
            <div class="sidebar-header">
                ...
                <div style="display: flex; flex-direction: column;">
                    ...
                    <span style="font-size: 0.75rem; color: var(--text-secondary); font-weight: 600; letter-spacing: 0.05em; text-transform: uppercase;">Oral Antibiotic</span>
                </div>
            </div>
