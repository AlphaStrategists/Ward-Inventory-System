...
class AntibioticController extends Controller
{
    public function index(Request $request)
    {
        ...
        foreach ($medicines as &$medicine) {
            ...
            if ($medicine['name'] === 'Amoxicillin 500mg') { $medicine['min_level'] = 10; $medicine['warning_limit'] = 30; } // Balance 25 -> YELLOW
            elseif ($medicine['name'] === 'Azithromycin 500mg') { $medicine['min_level'] = 50; $medicine['warning_limit'] = 80; } // Balance 45 -> RED
            elseif ($medicine['name'] === 'Cefuroxime 250mg') { $medicine['min_level'] = 5; $medicine['warning_limit'] = 10; } // Balance 8 -> YELLOW
            elseif ($medicine['name'] === 'Ciprofloxacin 500mg') { $medicine['min_level'] = 5; $medicine['warning_limit'] = 10; } // Balance 12 -> GREEN
            else {
        ...
        return view('components.antibiotic', [
            'medicines' => $medicines,
